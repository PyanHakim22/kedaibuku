...
$sql="SELECT id, namabuku, kategori, bilangan FROM buku WHERE id={$id}";
...
$sql = "UPDATE buku SET namabuku='{$namabuku}',kategori='{$kategori}',bilangan='{$bilangan}' WHERE id ={$id}";
...
echo "something went wrong".mysqli_error($conn);
    ...
    echo "<script type'text/javascript'>alert('User Edit successfully')</script>";
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form>
          ...
          <div class="container"><H1>Kemaskini Buku</H1></div>

          <div class="form-outline mb-4">
            <label class="form-label" for="form3Example3">Nama Buku</label>
            <input type="text" id="form3Example3" class="form-control form-control-lg"
              name="namabuku" value="<?php echo $namabuku ?>"/>
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="form3Example3" class="form-control form-control-lg"
               name="kategori" value="<?php echo $kategori ?>"/>
          ...
          <div class="form-outline mb-3">
           <label class="form-label" for="form3Example4">bilangan</label>
            <input type="text" id="form3Example4" class="form-control form-control-lg"
               name="bilangan" value="<?php echo $bilangan ?>"/>
